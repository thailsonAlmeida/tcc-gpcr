...
INSERT INTO tb_procedure(id_manager, id_patient, id_professional, data, start, finish, type, description, status ) VALUES (1, 1, 1, '21/09/2023', '10:00', '11:00', 'Evolutivo', 'It has survived not only five centuries, but also the leap into electronic typesetting', 'confirmar');
